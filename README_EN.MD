...
| [Claude API](./packages/adapter-claude) | Official API | Large context, often beats GPT-3.5 | Paid |
| [Deepseek](./packages/adapter-deepseek/) | Official API | Domestic renowned model | Performance close to or exceeding GPT-4o |
