...
export type EventListener = (conversation: Conversation, message?: Message) => void;
...
export interface Conversation {
   ...
   * 询问模型，但是可以自定义发送者等信息
   */
  ask(message: SimpleMessage): Promise<Message>
...
export namespace Conversation {
  export type Events = 'init' | 'send' | 'receive' | 'clear' | 'retry'
}
