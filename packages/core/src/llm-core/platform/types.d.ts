...
export declare enum ModelCapabilities {
    ToolCall = 'tool_call',
...
export declare function isModelInfo(model: any): model is ModelInfo
export declare function isPlatformModelInfo(
    model: any
): model is PlatformModelInfo
