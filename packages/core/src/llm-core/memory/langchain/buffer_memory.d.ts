 ...
 * const prompt =
 *   PromptTemplate.fromTemplate(`The foll details from its context. If the AI does not know the answer to a question, it truthfully says it does not know.
 *
 ...
 * ```
 */
export declare class BufferMemory
