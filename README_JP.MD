...
| [Claude API](./packages/adapter-claude) | 公式API | 大きなコンテキスト、GPT-3.5を上回ることが多い | 有料、Function Callなし |
| [Deepseek](./packages/adapter-deepseek/) | 公式API | 国内有名モデル | GPT-4oに近いかそれを超える性能 |
