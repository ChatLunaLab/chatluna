...
| [通义千问](./packages/qwen-adapter/README.md)          | 本地 Client，官方 API 接入    | 阿里出品国产模型，有开源版本，有免费额度            | 实测效果比智谱略好                                     |
| [豆包](./packages/doubao-adapter/README.md) | 本地 Client，官方 API 接入    | 字节出品模型，送免费额度                               | 实测效果比智谱略好                          |
